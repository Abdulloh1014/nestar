...
export class MemberResolver {
    ...
    /** A D M I N */
    // Authorization: memberType ni xam tekshiradi AGENT, ADMNIN
    ...
    // Kirib kelyotgan img qaysi folderga saqlanishi kerakligi
   ...
   @Args('target') target: String,): Promise<string[]> {
